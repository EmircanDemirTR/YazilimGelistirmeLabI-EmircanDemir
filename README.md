...
Proje kapsamında Unity kullanılarak oynanabilir bir sahne, karakter kontrolü ve etkileşim sistemleri tasarlanmıştır. Çalışma, yazılım geliştirme sürecinin planlama, uygulama ve test aşamalarını içermektedir.
...
2. Unity Hub üzerinden “Open Project” seçeneğiyle klasörü açın.
3. Projeye uygun Unity sürümünü (2022.x veya üstü) seçin.
4. Scenes klasörü içindeki ana sahneyi açın.
5. Oyun motoru üzerinden Play (▶) tuşuna basarak projeyi çalıştırabilirsiniz.
